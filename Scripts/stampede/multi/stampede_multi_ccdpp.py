...
for dataset, par_reg, numproc in datasets:
    for numcpu in numcpus:
        ...
        ofile.write("ibrun /home1/01846/cjhsieh/libpmf-mpi-1.4/mpi-ccdr1-omp -k %d -l %f -t 30 -n %d ../../../Data/%s/ ../../../TempFiles/%s.model > %s \n" % (dim, par_reg, numcpu, dataset, task_name, log_fname))
